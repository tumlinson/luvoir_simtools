...
# stars if that becomes important, which I think it will)
    if template.value != lasttemplate:
       ...
       if template.value == 'Venus':
          fn = 'coronagraph-master/planets/Venus_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = model[:,2]
       ...
       if template.value =='Archean Earth':
          fn = 'coronagraph-master/planets/ArcheanEarth_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = model[:,2]
       ...
       if template.value =='Hazy Archean Earth':
          fn = 'coronagraph-master/planets/Hazy_ArcheanEarth_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = model[:,2]
       ...
       if template.value =='1% PAL O2 Proterozoic Earth':
          fn = 'coronagraph-master/planets/proterozoic_hi_o2_geo_albedo.txt'
       ...
       if template.value =='0.1% PAL O2 Proterozoic Earth':
          fn = 'coronagraph-master/planets/proterozoic_low_o2_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = "BBody"
       ...
       if template.value =='Early Mars':
          fn = 'coronagraph-master/planets/EarlyMars_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = model[:,2]
       ...
       if template.value =='Mars':
          fn = 'coronagraph-master/planets/Mars_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Jupiter':
          fn = 'coronagraph-master/planets/Jupiter_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Saturn':
          fn = 'coronagraph-master/planets/Saturn_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Uranus':
          fn = 'coronagraph-master/planets/Uranus_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Neptune':
          fn = 'coronagraph-master/planets/Neptune_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='False O2 Planet (F2V star)':
          fn = 'coronagraph-master/planets/fstarcloudy_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = "Bbody"
