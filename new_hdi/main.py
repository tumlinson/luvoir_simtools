...
hover = HoverTool(attachment='vertical', 
        tooltips="""
        <div>
            <div>
...
button_plot = Figure(plot_height=240,plot_width=240, tools="tap",x_range=[0, 100], y_range=[0, 100],toolbar_location='below') 
image1 = "http://www.stsci.edu/~tumlinso/HDST_source_z2.jpg" 
image2 = "http://www.stsci.edu/~tumlinso/HST_source_z2.jpg"
button_plot.image_url(url=[image2], x=[0], y=[100], w=50, h=50, alpha=0.5) 
button_plot.image_url(url=[image2], x=[50], y=[100], w=50, h=50, alpha=0.5)
button_plot.image_url(url=[image1], x=[0], y=[50], w=50, h=50, alpha=0.5) 
button_plot.image_url(url=[image1], x=[50], y=[50], w=50, h=50, alpha=0.5)
...
inputs = Tabs(tabs=[ controls_tab, help_tab, button_tab]) 
