...
def set_plot_options(plot):
    ...
    x_label_source = ColumnDataSource(data={'x': [-1.0,0.0,1.0,2.0, 3.0],
                                        'y': [-13.5-0.2,-13.5-0.2,-13.5-0.2,-13.5-0.2,-13.5-0.2], 'text':['-1','0','1.0','2','3']})
    plot.text('x','y','text', source=x_label_source, text_align='center', text_font_size='15pt', text_color='deepskyblue')
    plot.text('x','y','text', source=y_label_source, text_font_size='15pt', text_color='deepskyblue', text_align='right')
    plot.quad(top=[7], bottom=[-13.0], left=[-1.2], right=[3.2], fill_alpha=0, line_width=2, line_color='black') 
