...
for iap = 0, n_elements(apertures)-1 do begin 
  ...
  for icon = 0, n_elements(contrasts)-1 do begin 
     ...
     restore, 'tumlinson-full_results-'+aperture_string+'_'+contrast_string+'_4.0_0.10_10.0.sav' 
     ...
     outfilename = 'run_'+aperture_string+'_'+contrast_string+'_4.0_0.10_10.0.fits' 
