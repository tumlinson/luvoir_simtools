...
xcoords = np.reshape(np.repeat([np.arange(200)/2.],[200],axis=0),40000) - 50. 
ycoords = np.reshape(np.repeat([np.arange(100)],[200],axis=1),20000) - 50. 
shutter_array = plot1.rect(xcoords, ycoords, width=0.45, height=0.9, color='grey', line_alpha=1.0, line_color='grey', fill_alpha=0.4) 
shutter_array.selection_glyph=Rect(line_color='red', line_alpha=0.8, line_width=4, fill_color='grey', fill_alpha=0.0) 
shutter_array.nonselection_glyph=Rect(line_color='grey', line_alpha=1.0, fill_color='grey', fill_alpha=0.4) 
