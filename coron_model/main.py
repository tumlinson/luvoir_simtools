...
if whichplanet == 'Earth':
   fn = cwd + 'coron_model/planets/earth_quadrature_radiance_refl.dat'
...
# stars if that becomes important, which I think it will)
    if template.value != lasttemplate:
       ...
       if template.value == 'Venus':
          fn = cwd+'coron_model/planets/new_venus.txt'
       ...
       if template.value =='Archean Earth':
          fn = cwd+'coron_model/planets/ArcheanEarth_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = model[:,2]
       ...
       if template.value =='Hazy Archean Earth':
          fn = cwd+'coron_model/planets/Hazy_ArcheanEarth_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = model[:,2]
       ...
       if template.value =='1% PAL O2 Proterozoic Earth':
          fn = cwd+'coron_model/planets/proterozoic_hi_o2_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = "BBody"
       ...
       if template.value =='0.1% PAL O2 Proterozoic Earth':
          fn = cwd+'coron_model/planets/proterozoic_low_o2_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = "BBody"
       ...
       if template.value =='Early Mars':
          fn = cwd+'coron_model/planets/EarlyMars_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = model[:,2]
       ...
       if template.value =='Mars':
          fn = cwd+'coron_model/planets/Mars_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=8)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Jupiter':
          fn = cwd+'coron_model/planets/Jupiter_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Saturn':
          fn = cwd+'coron_model/planets/Saturn_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Uranus':
          fn = cwd+'coron_model/planets/Uranus_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Neptune':
          fn = cwd+'coron_model/planets/Neptune_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = 'Bbody'
       ...
       if template.value =='Warm Neptune at 2 AU':
          fn = cwd+'coron_model/planets/Reflection_a2_m1.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
       ...
       if template.value =='Warm Neptune w/o Clouds at 1 AU':
          fn = cwd+'coron_model/planets/Reflection_a1_m2.6_LM_NoCloud.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          lamhr_ = lamhr_ / 1000. #convert to microns
       ...
       if template.value =='Warm Neptune w/ Clouds at 1 AU':
          fn = cwd+'coron_model/planets/Reflection_a1_m2.6_LM.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          lamhr_ = lamhr_ / 1000. #convert to microns
       ...
       if template.value =='Warm Jupiter at 0.8 AU':
          fn = cwd+'coron_model/planets/0.8AU_3x.txt'
       ...
       if template.value =='Warm Jupiter at 2 AU':
          fn = cwd+'coron_model/planets/2AU_3x.txt'
          model = np.loadtxt(fn, skiprows=1)
          lamhr_ = model[:,1]
          Ahr_ = model[:,3]
          solhr_ = 'Bbody'
       ...
       if template.value =='False O2 Planet (F2V star)':
          fn = cwd+'coron_model/planets/fstarcloudy_geo_albedo.txt'
          model = np.loadtxt(fn, skiprows=0)
          lamhr_ = model[:,0]
          Ahr_ = model[:,1]
          solhr_ = "Bbody"
